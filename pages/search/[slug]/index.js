                    ...
                    return(
                      <div key={`results${i}`} className={`search-item ${item.attributes?.category?.data?.attributes?.slug}`}>
                        <div className="item-wrapper">
                          <a href={item.attributes.biennial ? `/programme/${ item.attributes.main ? item.attributes.slug : `sub/${item.attributes.slug}`}` : `/${categories[index]}/${item.attributes.slug}`} key={'search'+i}>
                            <div className="image">
